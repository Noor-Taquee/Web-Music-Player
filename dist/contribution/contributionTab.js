...
artistNameInputOuterDiv.appendChild(createElement("div", {
    className: "contribution-form-input-div"
}, [
...
function addArtist() {
    artistNameInputOuterDiv.insertBefore(createElement("div", { className: "contribution-form-input-div" }, [
        createElement("i", { className: "ph-bold ph-user" }),
        createElement("input", {
            type: "text",
            placeholder: "Artist",
...
function hideMessageCT() {
    ...
    messageDivCT.addEventListener("animationend", () => {
        messageDivCT.style.display = "none";
    }, { once: true });
}
export {};
//# sourceMappingURL=contributionTab.js.map