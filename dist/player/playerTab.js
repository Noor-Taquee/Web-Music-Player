...
function showMore() {
    ...
    moreDiv.addEventListener("animationend", () => {
...
function focusPLOn() {
    if (currentFocusPL == "lyrics") {
        ...
        lyricsDiv.addEventListener("animationend", () => {
...
function showSongInfo() {
    ...
    songInfoDiv.addEventListener("animationend", () => {
...
reportSongPanelBtnDiv.appendChild(createElement("button", {
...
function reportSong() {
    if (signedIn) {
        ...
        reportSongInfoPanel.addEventListener("animationend", () => {
...
function sendReportSongInfo() {
    if (reportSongInfoInput.value.trim().length > 0) {
        ...
        sendNotification("noortaquee", "ERROR REPORT", `${userName} reported an issue with the song "${selectedSongToReport}": "${reportSongInfoInput.value}"`).then(() => {
