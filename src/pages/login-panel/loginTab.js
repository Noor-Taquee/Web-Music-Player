...
function openLoginPanel() {
  if (loginPanel.style.display == "flex") return;
...
const formContainerLT = createElement("div", {
...
signInPassEye.addEventListener("click", () => {
  togglePasswordVisibilty(signInPassEye, passInputSignIn);
});
signInForm.appendChild(
  createElement(
    "div",
...
signUpForm.appendChild(
  createElement(
    ...
    [
      createElement("i", { className: "ph-bold ph-user-rectangle" }),
      fullNameInputSignUp,
    ],
  ),
);
...
signUpPassEye.addEventListener("click", () => {
  togglePasswordVisibilty(signUpPassEye, passInputSignUp);
});
signUpForm.appendChild(
  createElement(
    "div",
...
bnSignUpCon.appendChild(
  createElement("i", { className: "ph-bold ph-circle-notch" }),
);
bnSignUp.appendChild(bnSignUpCon);
//#endregion Sign-up form

const bottomContainerLT = createElement("div", {
  className: "login-panel-bottom-container",
});
...
const bnCreateAC = createElement(
  "button",
  {
    className: "register-btn",
  },
