...
function createSongBtn(songs, Name, artist, image, className = "rectangle") {
  ...
  const aboutSongDiv = createElement(
    "div",
    {
...
const homeContentDiv = createElement("div", {
  className: "home-tab-content-div",
});
...
const homeCategoryDiv = createElement("div", {
  className: "home-song-category-div",
});
// homeHeaderDiv.appendChild(homeCategoryDiv);

const bnHindiSongs = createElement("button", { onclick: null }, [
  createElement("p", { textContent: "Hindi" }),
]);
homeCategoryDiv.appendChild(bnHindiSongs);
const hindiSongsDiv = createElement("div", {
  className: "home-tab-content-div",
});

const bnPunjabiSongs = createElement("button", { onclick: null }, [
  createElement("p", { textContent: "Punjabi" }),
]);
homeCategoryDiv.appendChild(bnPunjabiSongs);
const punjabiSongsDiv = createElement("div", {
  className: "home-tab-content-div",
});

const bnEnglishSongs = createElement("button", { onclick: null }, [
  createElement("p", { textContent: "English" }),
]);
homeCategoryDiv.appendChild(bnEnglishSongs);
const englishSongsDiv = createElement("div", {
  className: "home-tab-content-div",
});

const bnPhonkSongs = createElement("button", { onclick: null }, [
  createElement("p", { textContent: "Phonk" }),
]);
homeCategoryDiv.appendChild(bnPhonkSongs);
const phonkSongsDiv = createElement("div", {
  className: "home-tab-content-div",
});

const bnSpanishSongs = createElement("button", { onclick: null }, [
  createElement("p", { textContent: "Spanish" }),
]);
homeCategoryDiv.appendChild(bnSpanishSongs);
const spanishSongsDiv = createElement("div", {
  className: "home-tab-content-div",
});

const bnTunes = createElement("button", { onclick: null }, [
  createElement("p", { textContent: "Tunes" }),
]);
homeCategoryDiv.appendChild(bnTunes);
const tunesDiv = createElement("div", { className: "home-tab-content-div" });

const bnPartySongs = createElement("button", { onclick: null }, [
  createElement("p", { textContent: "Party" }),
]);
homeCategoryDiv.appendChild(bnPartySongs);
const partySongsDiv = createElement("div", {
  className: "home-tab-content-div",
});

const bnRomanticSongs = createElement("button", { onclick: null }, [
  createElement("p", { textContent: "Romantic" }),
]);
homeCategoryDiv.appendChild(bnRomanticSongs);
const romanticSongsDiv = createElement("div", {
  className: "home-tab-content-div",
});

const bnSlowedSongs = createElement("button", { onclick: null }, [
  createElement("p", { textContent: "Slowed" }),
]);
homeCategoryDiv.appendChild(bnSlowedSongs);
const slowedSongsDiv = createElement("div", {
  className: "home-tab-content-div",
});

const bnDanceSongs = createElement("button", { onclick: null }, [
  createElement("p", { textContent: "Dance" }),
]);
homeCategoryDiv.appendChild(bnDanceSongs);
const danceSongsDiv = createElement("div", {
  className: "home-tab-content-div",
});

const bnChillSongs = createElement("button", { onclick: null }, [
  createElement("p", { textContent: "Chill" }),
]);
homeCategoryDiv.appendChild(bnChillSongs);
const chillSongsDiv = createElement("div", {
  className: "home-tab-content-div",
});
...
function loadRecentlyPlayedSongs() {
  ...
  currentUser.recentlyPlayedSongList.forEach((song) => {
    recentlyPlayedDivCon.appendChild(
      createSongBtn(
        song,
        songData[song].name,
