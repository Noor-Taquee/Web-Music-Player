...
// AUDIO QUALITY DIV================================
const audioQualityPanel = createElement("div", {
...
audioQualityPanel_topBar.appendChild(
  createElement(
    "button",
    { className: "back-btn toggle", onclick: closeAudioQualityPanel },
...
const audioQualityPanelP = createElement("p", {
  textContent: "This feature will be available soon!",
});
