...
const notificationsPanel = createElement("div", {
  className: "settings-tab-inner-panel",
});

const notificationsPanel_topBar = createElement("div", {
  className: "top-bar",
});
notificationsPanel.appendChild(notificationsPanel_topBar);

notificationsPanel_topBar.appendChild(
  createElement(
    "button",
    {
...
const notificationsPanel_content = createElement("div", {
...
function createNotification(notification) {
  const notificationDiv = createElement("div", {
  ...
  const bnRemoveNotification = createElement(
    "button",
    {
  ...
  const notificationMetaDataDiv = createElement("div", {
    className: "notification-meta-data-div",
  });
