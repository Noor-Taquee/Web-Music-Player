...
const manageHistoryPanel = createElement("div", {
...
manageHistoryPanelTopBar.appendChild(
  createElement(
    "button",
    { className: "back-btn toggle", onclick: closeManageHistoryPanel },
    [createElement("i", { className: "ph-bold ph-arrow-left" })],
  ),
);
manageHistoryPanelTopBar.appendChild(
  createElement("p", { className: "top-bar-text", textContent: "History" }),
);
...
const manageHistory_permissionSection = createElement("div", {
...
AllowHistoryDiv.appendChild(
  createElement("p", {
    ...
    textContent: "Allow history",
  }),
);

const AllowHistoryToggle = createElement("div", {
...
const AllowHistoryToggleBall = createElement("div", {
...
const manageHistory_clearSection = createElement("div", {
  className: "settings-section",
});
manageHistoryConDiv.appendChild(manageHistory_clearSection);

const bnClearSearchHistory = createElement(
  "button",
  {
    id: "clear-search-history",
    className: "clear-history-btn",
    onclick: f_clearSearchHistory,
  },
  [createElement("p", { textContent: "Clear search history" })],
);
manageHistory_clearSection.appendChild(bnClearSearchHistory);

const bnClearPlayedSongHistory = createElement(
  "button",
  {
    id: "clear-played-song-history",
    className: "clear-history-btn",
    onclick: f_clearPlayedSongHistory,
  },
  [createElement("p", { textContent: "Clear played song history" })],
);
...
async function f_clearPlayedSongHistory() {
  ...
  currentUser.recentlyPlayedSongList.splice(
    0,
    currentUser.recentlyPlayedSongList.length,
  );
