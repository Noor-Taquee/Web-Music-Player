...
//#region UI
const appearancePanel = createElement("div", {
...
appearancePanel_topBar.appendChild(
  createElement(
    "button",
    {
...
const appearancePanel_themeSection = createElement("div", {
...
function syncTheme() {
  ...
  if (appliedOption) {
    ...
    appliedOption
      .querySelector("i")
      .classList.replace("ph-radio-button", "ph-circle");
  ...
  selectedOption
    .querySelector("i")
    .classList.replace("ph-circle", "ph-radio-button");
}

//#region theme selection
const themeDiv = createElement("div", {
  className: "selection-div inactive",
  id: "theme-div",
});
...
const themeSelectionCon = createElement("div", {
  className: "selection-content",
});
themeDiv.appendChild(themeSelectionCon);

const themeOptionContainer = createElement("div", {
  className: "selection-option-container",
});
...
lightOption.addEventListener("click", () => {
  if (themeDiv.classList.contains("inactive")) return;

  setTheme("light");
  syncTheme();
});

const lightOptionImageDiv = createElement("div", {
  className: "option-image-div",
});
...
const lightOptionImageInnerDiv = createElement("div", {
  className: "option-image-inner-div",
});
...
const lightOptionSelectionInd = createElement("div", {
...
const darkOptionImageDiv = createElement("div", {
  className: "option-image-div",
});
...
const darkOptionImageInnerDiv = createElement("div", {
  className: "option-image-inner-div",
});
...
const darkOptionSelectionInd = createElement("div", {
  className: "selection-indicator",
});
...
autoTheme_ToggleDiv.appendChild(
  createElement("p", {
...
const autoThemeToggle = createElement("div", {
...
function toggleAutoTheme() {
  if (autoTheme_ToggleDiv.classList.contains("inactive")) return;
...
//#region blur
const appearancePanel_blurSection = createElement("div", {
  className: "settings-section",
});
...
changeBlur_toggleDiv.appendChild(
  createElement(
    "p",
    {
      className: "toggle-div-text",
...
function toggleBlur() {
  if (changeBlur_toggleDiv.classList.contains("inactive")) return;

  changeBlurToggle.classList.toggle("active");
  app.dataset.blur = changeBlurToggle.classList.contains("active")
    ? "true"
    : "false";
}

const blurIntensity_sliderDiv = createElement("div", {
...
const blurIntensity_sliderDiv_header = createElement("div", {
  className: "header",
});
blurIntensity_sliderDiv.appendChild(blurIntensity_sliderDiv_header);
blurIntensity_sliderDiv_header.appendChild(
  createElement("p", {
...
const blurIntensity_sliderDiv_content = createElement("div", {
  className: "content",
});
...
blurIntensitySlider.addEventListener(
  "touchdown",
  (e) => {
    e.preventDefault();
  },
...
const transparency_sliderDiv = createElement("div", {
  className: "slider-div",
});
appearancePanel_blurSection.appendChild(createElement("hr"));
appearancePanel_blurSection.appendChild(transparency_sliderDiv);

const transparency_sliderDiv_header = createElement("div", {
  className: "header",
});
transparency_sliderDiv.appendChild(transparency_sliderDiv_header);
transparency_sliderDiv_header.appendChild(
  createElement("p", {
    className: "slider-div-text",
...
const transparency_sliderDiv_content = createElement("div", {
  className: "content",
});
...
const appearancePanel_navSection = createElement("div", {
  className: "settings-section",
});
...
const changeNavBarStyle_toggleDiv = createElement("div", {
  className: "toggle-div",
});

appearancePanel_navSection.appendChild(changeNavBarStyle_toggleDiv);

changeNavBarStyle_toggleDiv.appendChild(
  createElement("p", {
    className: "toggle-div-text",
...
const changeNavBarStyleToggle = createElement("div", {
  className: "toggle-element active",
});
...
const changeNavBarStyleToggleBall = createElement("div", {
  className: "toggle-ball",
});
changeNavBarStyleToggle.appendChild(changeNavBarStyleToggleBall);

function changeNavBarStyle() {
  if (changeNavBarStyle_toggleDiv.classList.contains("inactive")) return;

  changeNavBarStyleToggle.classList.toggle("active");
  bottomDiv.dataset.style = changeNavBarStyleToggle.classList.contains("active")
    ? "floating"
    : "sticky";
}
