...
settingsPanel_content.appendChild(
  settingsPanel_accountSettings_buttonContainer,
);
...
const changePassBtn = createSettingsPanelBtn(
  ...
  () => {
    openImportedPanel(
      ...
      "src/settings/change-password.js",
      true,
    );
  },
);
...
const manageHistoryBtn = createSettingsPanelBtn(
  ...
  () => {
    openImportedPanel(
      ...
      "src/settings/manage-history.js",
      true,
    );
  },
);
...
const changeThemeBtn = createSettingsPanelBtn(
  settingsPanel_appSettings_buttonContainer,
  "sun-dim",
  "Appearance",
  "Theme, blur, navigation",
  () => {
    openImportedPanel(
      "appearance-js",
      openAppearancePanel,
...
const contributeBtn = createSettingsPanelBtn(
  settingsPanel_miscSettings_buttonContainer,
  "music-notes-plus",
  "Contribution",
  ...
  () => {
    openImportedPanel(
      ...
      "src/contribution/contributionTab.js",
      true,
    );
  },
);
