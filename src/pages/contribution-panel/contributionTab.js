if (!document.getElementById("contribution-css")) {
  addLink(
    "contribution-css",
    "src/contribution/contributionTab.css",
    "stylesheet",
  ).onload = async () => {
...
const ct_backBtn = createElement(
  "button",
  {
...
const bnContributeCT = createElement(
  "button",
  {
...
const contributionInputOuterDiv = createElement("div", {
  className: "contribution-form-div",
});

const contributionInputDiv = createElement("div", {
...
const artistNameInputOuterDiv = createElement("div", {
  className: "artist-input-div",
});
...
const bnAddArtist = createElement(
  "button",
  {
...
const contributionHelpDiv = createElement("div", {
  className: "contribution-help-content-div",
});
contributionContent.appendChild(contributionHelpDiv);

contributionHelpDiv.appendChild(
  createElement("p", {
    className: "imp",
    textContent: "Thank you for contributing to our music library!",
  }),
);
...
contributionHelpDiv.appendChild(
  createElement("p", {
    className: "imp",
    textContent: "Before you start, make sure you have a dropbox account.",
  }),
);
...
contributionHelpDiv.appendChild(
  createElement("p", {
    ...
    textContent: "STEP-1: FILL OUT THE SONG DETAILS",
  }),
);
...
const aboutSongP = createElement("p", {
  className: "key-value",
  textContent: "About the song:",
});
contributionHelpDiv.appendChild(aboutSongP);
const aboutSongSpan = createElement("span");
aboutSongP.appendChild(aboutSongSpan);
aboutSongSpan.textContent =
  "A short description(please include the language of the song).";

contributionHelpDiv.appendChild(
  createElement("p", {
    className: "steps-text",
    textContent: "STEP-2: GET YOUR SONG LINK FROM DROPBOX",
  }),
);
...
contributionHelpDiv.appendChild(
  createElement("p", { textContent: "Open the Dropbox app or website." }),
);

contributionHelpDiv.appendChild(
  createElement("p", {
    textContent: "Navigate to the song file you want to share.",
  }),
);

contributionHelpDiv.appendChild(
  createElement("p", { textContent: "Tap on the three dots on the file" }),
);
...
contributionHelpDiv.appendChild(
  createElement("p", { textContent: "Tap share." }),
);
...
contributionHelpDiv.appendChild(
  createElement("p", { textContent: "Copy this link. This is the SONG LINK." }),
);
...
contributionHelpDiv.appendChild(
  createElement("p", {
    className: "steps-text",
    textContent: "STEP 3: FIND AN ALBUM ART",
  }),
);
...
contributionHelpDiv.appendChild(
  createElement("p", { textContent: "Open your browser." }),
);

contributionHelpDiv.appendChild(
  createElement("p", {
    textContent: "Search for the album art and tap on the image.",
  }),
);
...
contributionHelpDiv.appendChild(
  createElement("p", {
    textContent: "Press and hold the image until a popup appears.",
  }),
);

contributionHelpDiv.appendChild(
  createElement("p", { textContent: "open the image in a new tab." }),
);
...
contributionHelpDiv.appendChild(
  createElement("p", { textContent: "Tap the link on your address bar." }),
);
...
contributionHelpDiv.appendChild(
  createElement("p", { textContent: "Copy this link.This is the IMAGE LINK" }),
);
...
contributionHelpDiv.appendChild(
  createElement("p", {
    className: "steps-text",
    textContent: "STEP 4: SUBMIT YOUR CONTRIBUTION",
  }),
);
...
function ELforArtists() {
  document
    .querySelectorAll(".contribution-form-input.artist")
    .forEach((input) => {
